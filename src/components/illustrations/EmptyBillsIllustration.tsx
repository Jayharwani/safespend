export default function EmptyBillsIllustration() {
  return (
    <svg viewBox="0 0 120 100" className="w-[100px] h-[84px] mx-auto mb-4" aria-hidden>
      ...
      <rect x="32" y="32" width="32" height="5" rx="2.5" fill="var(--brand)" opacity="0.3" />
      ...
      <circle cx="88" cy="28" r="14" fill="var(--brand-soft)" stroke="var(--brand)" strokeWidth="1.5" className="illus-float" />
      <text x="88" y="33" textAnchor="middle" fontSize="16" fill="var(--brand-deep)" fontWeight="600">
        +
      </text>
    </svg>
  );
