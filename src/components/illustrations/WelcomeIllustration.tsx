  ...
  return (
    ...
    >
      ...
      <g className="illus-float" style={{ animationDelay: "0.2s" }} filter="url(#wl-shadow)">
        ...
        <rect x="104" y="88" width="48" height="8" rx="4" fill="var(--accent)" opacity="0.35" />
        <text x="118" y="128" fontSize="28" fontWeight="600" fill="var(--accent-deep)" fontFamily="inherit">
          $885
        </text>
      ...
      <g className="illus-float-delayed">
        <circle cx="72" cy="58" r="22" fill="var(--accent-soft)" stroke="var(--accent)" strokeWidth="1.5" opacity="0.9" />
        <text x="72" y="64" textAnchor="middle" fontSize="16" fill="var(--accent-deep)" fontWeight="600">
          $
        </text>
      </g>
      ...
      <g className="illus-float-delayed" style={{ animationDelay: "1s" }}>
        ...
        />
        <circle cx="267" cy="162" r="24" fill="var(--accent-soft)" stroke="var(--accent)" strokeWidth="1.5" opacity="0.85" />
      </g>

      <g className="illus-drift">
        <circle cx="48" cy="168" r="6" fill="var(--accent)" opacity="0.25" />
        <circle cx="280" cy="118" r="4" fill="var(--tight)" opacity="0.3" />
        <circle cx="200" cy="42" r="5" fill="var(--accent)" opacity="0.2" />
      </g>
    </svg>
  );
}
